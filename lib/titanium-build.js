...
module.exports = {
      ...
      parser: function(result) {
        _.each(result.simulators.ios, function(simulators, os) {
          _.each(simulators, function(simulator) {
            ...
            console.log(atom.titaniumBuildConfigs.args);
          });
        });
      }
    });
  ...
  new: function() {
    atom.titaniumBuildConfigs = [{
      ...
      "args": ["new -t titanium --no-services --project-dir /Users/grazianogrespan/Desktop/AppTest -n AppTest -i grazianogrespan.AppTest -f"]
    }];
